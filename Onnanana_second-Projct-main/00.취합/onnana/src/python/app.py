...
def execute_after_app_start():
    ...
    # '미세먼지' 처리 이후에 그래프 그리기
    drawKorea('미세먼지', main, 'Blues', save_filename='D:/WorkSpace/SecondProject23.11/Onnanana_second-Projct-main/00.취합/onnana/src/main/resources/static/img/카토그램.png')
    print('카토그램이 완성되었습니다.')
